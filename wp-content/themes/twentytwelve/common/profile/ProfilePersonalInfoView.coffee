...
class Xoomapp.ProfilePersonalInfoView extends Marionette.ItemView
	...
	template : '<div ><div class="response_msg"></div>
			          ...
			          <div class="row">
			              <img src="http://www.xooma.ajency.in/xooma/wp-content/themes/twentytwelve/img/profile.jpg"  class="img-circle"/>
			              	<input type="hidden" name="image" id="image" value="http://www.xooma.ajency.in/xooma/wp-content/themes/twentytwelve/img/profile.jpg" /> 
