...
(function(root, factory) {
	...
	Marionette.AppStates = (function(_super) {
		...
		AppStates.prototype._processStateOnRoute = function(name, args) {
			...
			this._app.triggerMethod('state:transition:start', event, stateModel, args);
			...
			currentStateProcessor.done((function(_this) {
				return function(processor) {
					return _this._app.triggerMethod('state:transition:complete', event, stateModel, args);
				};
			})(this)).fail((function(_this) {
				return function(error) {
					return _this._app.triggerMethod('state:transition:error', event, stateModel, args);
				};
			})(this));
