			...
			<?php 
				...
				foreach($myarray as $testimonial):
					...
					echo '{
							...
							HTML: "<div class=\'facebook_button\' style=\'   position: absolute; z-index: 99999; margin-left: 214px; \'></div><a href=\'' . get_permalink($testimonial->ID) .'\'><h4 class=\'testimonialTitle\'>'. addslashes($testimonial->post_title) .'</h4></a>Country</br> <span> '. $country . '</span><div class=\'slickscroll\'><div>'. $content .'</div><br /><a href=\'' . get_permalink($testimonial->ID) .'\'>Complete View</a></div>",
