...
if(is_plugin_active('json-rest-api/plugin.php')){
    ...
    class CommunicationModuleAPI {
        ...
        public function get_template_preview($data){
            ...
            $preview_response = $aj_comm->get_template_preview($data);
                     
            if(array_key_exists('html', $preview_response)){
                wp_send_json_success($preview_response);
            }else{
                wp_send_json_error($preview_response);
            }
